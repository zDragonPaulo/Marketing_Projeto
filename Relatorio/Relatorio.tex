...
Nesta parte será abordado a exequibilidade do produto, será visto a 
%---------------------------------------------------------------------------------------------------------------------------
\subsubsection{Posicionamento}\label{posicionamento}
O posicionamento deste produto será posta como uma solução moderna, sendo acessível e facíl de se usar por qualquer pessoa que deseja automatizar a sua casa.
%---------------------------------------------------------------------------------------------------------------------------
...
Neste ponto, vai se falar como este produto é uma solução multifuncional, pois este combina as características de uma extensão, uma tomada inteligente e dispositivo de automatização doméstica.
...
O preço do produto foi definido de maneira a que haja um equilíbrio entre custo e acessabilidade. Tendo esta uma estratégia para dois mercados:
\begin{itemize}
