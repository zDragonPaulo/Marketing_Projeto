...
Os custos variáveis são os custos que a empresa terá de suportar dependendo do volume de vendas, no nosso caso não temos nenhum custo variável.

\begin{figure}[h!]
	\centering
	\includegraphics[width=6cm]{Recursos/CFEV.png} 
\end{figure}
...
mercados nacionais e externos respetivamente. Estes custos também tem o IVA de 23\% em consideração.

\begin{figure}[h!]
	\centering
	\includegraphics[width=6cm]{Recursos/CMVCM.png} 
\end{figure}
...
com uma boa margem de lucro que permite um bom crescimento da empresa.

\begin{figure}[h!]
	\centering
	\includegraphics[width=6cm]{Recursos/Avaliação.png} 
\end{figure}
%-----------------------------------Martinho TRABALHO ENDS HERE-------------------------------------------------------------------
\newpage
