...
Este produto será colocado como uma solução moderna, sendo acessível e fácil de se usar por qualquer pessoa que deseja automatizar a sua casa.
O produto foi desenvolvido com o objetivo de democratizar o acesso à tecnologia smart home, permitindo utilizadores com diferentes níveis de conhecimento técnico consigam tirar partido das suas funcionalidades avançadas sem dificuldades.
%---------------------------------------------------------------------------------------------------------------------------
...
\end{itemize}
Esta diferença existe pois, há diferença no custo de exportação para o exterior. Para facilitar a entrada no mercado, estão previstas ações promocionais de 
lançamento, como descontos temporários para os primeiros clientes, ofertas em packs (ex: duas unidades com preço reduzido) e campanhas com portes gratuitos 
em compras superiores a um determinado valor. Contudo, caso o produto tenha um sucesso maior que o esperado, existe a possibilidade de aumentar 
...
\subsection{Equipa de Projeto}\label{equipa}
A equipa de projeto é composta por cinco elementos, no primeiro ano, onde cada um dos elementos tem uma única função principal,
porém todos os elementos devem possuir conhecimentos para auxiliar os outros funcionários, caso seja necessário. Este número de funcionários
pode ser aumentado, caso o produto tenha um grande sucesso e seja necessário aumentar a produção do mesmo. Funcionários complementares de
algumas tarefas podem ser contratados durante um período de tempo, caso seja necessário aumentar a produção para corresponder às expectativas.


%-----------------------------------PAULO TRABALHO ENDS HERE-------------------------------------------------------------------

\newpage
\section{Plano Financeiro}\label{financas}

Considerando todas as informações apresentadas anteriormente, um plano financeiro foi elaborado para o produto, com o objetivo de
analisar a viabilidade do mesmo e o seu potencial de crescimento.
%---------------------------------------------------------------------------------------------------------------------------
%----------------------------PAULO TRABALHO STARTS HERE---------------------------------------------------------------

\subsection{Vendas}\label{vendas}
Após a análise do mercado e do público alvo, foi o grupo conclui que o produto terá um sucesso inicial inferior em 
território nacional, devido à pouca utilização de produtos que tornem as casas mais inteligentes, e que o mesmo irá ter um sucesso maior
em território internacional, onde a utilização de produtos que tornem as casas mais inteligentes é bastante maior e mais comum no dia a dia. 


Mesmo assim, o grupo acredita que é possível haver 5000 vendas do produto em território nacional no primeiro ano, e que o mesmo terá chance 
de aumentar progressivamente, como é possível ver na figura \ref{fig:vendasnacional}.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Recursos/VendasNacional.png}
    \caption{Vendas do Produto em Portugal}
    \label{fig:vendasnacional}
    
\end{figure}

Já em território internacional, onde o grupo acredita que haverá um maior sucesso do produto, o grupo idealiza uma venda de 10000 unidades no primeiro ano,
e que o mesmo irá aumentar progressivamente, como é possível ver na figura \ref{fig:vendasinternacional}.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Recursos/VendasExternas.png}
    \caption{Vendas do Produto Internacional}
    \label{fig:vendasinternacional}
\end{figure}

É importante destacar de que o mercado está em constante mudança, e que o produto pode ter um sucesso maior ou menor do que o esperado, dependendo da aceitação 
do mesmo por parte dos utilizadores, mas tudo indica que o produto irá ter sucesso, considerando o crescente interesse em produtos que ajudem 
a tornar as casas mais inteligentes e a facilitar a vida dos utilizadores.
%---------------------------------------------------------------------------------------------------------------------------
\subsection{Recursos Humanos}\label{recursoshumanos}
Com base nas vendas previstas, o grupo idealizou o número de funcionários necessários inicialmente para o desenvolvimento do produto, 
e como o mesmo irá proporcionalmente aumentar com o aumento das vendas do produto.
O grupo acredita que inicialmente serão necessários cerca de \mbox{6 funcionários}, sendo que o mesmo irá aumentar progressivamente, como é possível ver \mbox{na figura \ref{fig:recursoshumanos}}. 
Existe um maior número de funcionários no Marketing para ajudar a promover as conexões com outras empresas e ser possível aumentar as vendas do produto, a partir 
de colaborações.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Recursos/RH1.png}
    \caption{Recursos Humanos - Número de Funcionários}
    \label{fig:recursoshumanos}
\end{figure}

Os salários dos funcionários foi decidido considerando a importância de cada um deles para o desenvolvimento do produto, sendo que os funcionários mais importantes 
estão sujeitos a aumentos de salários anualmente, como é possível ver na figura \ref{fig:salarios}.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{Recursos/RH2.png}
    \caption{Recursos Humanos - Salários}
    \label{fig:salarios}
\end{figure}
...
\subsection{Custos Fixos e Variáveis}\label{custosfixosevariaveis}

Em relação aos custos fixos, estes são os custos que a empresa terá de suportar mensalmente independentemente do volume de vendas, cujos quais incluem
despesas relacionadas a imoveis como as de maior valor, seguidas de royalties e publicidade. Outros custos fixos incluem seguros, combustiveis para deslocação e honorários.
Os custos variáveis são os custos que a empresa terá de suportar dependendo do volume de vendas, no nosso caso não temos nenhum custo variável, como é possível 
ver na figura \ref{fig:cfev}.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.957\textwidth]{Recursos/CFEV.png} 
    \caption{Custos Fixos e Variáveis}
    \label{fig:cfev}
\end{figure}

\newpage
%---------------------------------------------------------------------------------------------------------------------------
\subsection{CMVCMC}\label{cmvcmc}
Os nossos custos de produção são os custos que a empresa terá de suportar para produzir o produto. Estes tem como margem bruta 60\% e 40\% para os
mercados nacionais e externos respetivamente. Estes custos também tem o IVA de 23\% em consideração, como é possível ver na figura \ref{fig:cmvcmc}.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{Recursos/CMVCM.png}
    \caption{Custos de Produção}
    \label{fig:cmvcmc} 
\end{figure}
%---------------------------------------------------------------------------------------------------------------------------
\subsection{Avaliação do Investimento}\label{avaliacaoinvestimento}
Finalmente temos a avaliação do investimento, onde podemos ver após 3 anos a empresa torna-se lucrativa, 
com uma boa margem de lucro que permite um bom crescimento da empresa. Com uma taxa interna de rentabilidade de 98.01\% e um valor de 
cerca de 2.5 Milhões de euros acumulados após 5 anos de vendas, como é possível ver na figura \ref{fig:avaliacao}.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{Recursos/Avaliação.png}
    \caption{Avaliação do Investimento}
    \label{fig:avaliacao}
\end{figure}
%-----------------------------------Martinho TRABALHO ENDS HERE-------------------------------------------------------------------
\newpage
